...
const TopicsSideBar: React.FC = () => {
    ...
    return (
        <aside
            className={`h-screen fixed left-0 top-13 bg-gray-950 text-gray-200 flex flex-col border-r border-gray-800 overflow-y-auto px-3 py-4 transition-all duration-300 ${
                collapsed ? "w-16" : "w-64"
            }`}
        >
